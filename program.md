...
**Session chair:** _Letizia Tanca (Politecnico di Milano)_

- #2 -
  Luigi Bellomarini (Banca d’Italia);
  Anna Bernasconi (Politecnico di Milano);
  Stefano Ceri (Politecnico di Milano);
  Alessia Ms. Gagliardi (Politecnico di Milano);
  Davide Magnanimi (Banca d’Italia);
  Davide Martinenghi (Politecnico di Milano)\* -
  **Towards a Standard for Triggers in Property Graphs**
  _(4mins)_ \[[pdf](papers/paper02.pdf)\]
- #3 -
  Chiara Forresi (DISI - University of Bologna);
...
- #4 -
  ...
  **ReliK: A Reliability Measure for Knowledge Graph Embeddings**
  _(4mins)_ \[[pdf](papers/paper04.pdf)\]
- #6 -
  Fariha Maqbool (University of Milano Bicocca);
  Blerina Spahiu (unimib);
  Andrea Maurino (Università di Milano Bicocca)\* -
  **Impact of Data Augmentation on Hate Speech Detection in Roman Urdu**
  _(4mins)_ \[[pdf](papers/paper06.pdf)\]
- #12 -
  ...
  **Autonomous Intelligent Systems: From Illusion of Control to Inescapable Delusion**
  _(4mins)_ \[[pdf](papers/paper12.pdf)\]
- #14 -
  Enea Vincenzo Napolitano (University of Naples Federico II)\*;
  Elio Masciari (University of Naples, Italy);
  Flavia Indrio (University of Salento);
  Flavia Marchese (University of Foggia);
  Matteo Rinaldi (Ospedali Riuniti Foggia);
  Gianfranco Maffei (Ospedali Riuniti Foggia);
  Isadora Beghetti (University of Bologna);
  Luigi Corvaglia (University of Bologna);
  Arianna Aceti (University of Bologna) -
  **Infantile Predictors of Functional Gastrointestinal Disorders: A Machine Learning Approach to Risk Assessment**
  _(4mins)_ \[[pdf](papers/paper14.pdf)\]
- #16 -
  Alessia Bardi (CNR - ISTI)\*;
  Miriam Baglioni (CNR);
  Andrea Mannocci (CNR - ISTI);
  Gina Pavone (CNR) -
  **The ARIADNEplus Knowledge Base**
  _(4mins)_ \[[pdf](papers/paper16.pdf)\]
- #20 -
  Ilaria Bartolini (University of Bologna);
  Angelo Chianese (University of Naples Federico II);
  Vincenzo Moscato (University of Naples “Federico II”);
  Marco Postiglione (Federico II);
  Giancarlo Sperlì (University of Naples Federico II)\*;
  Andrea Vignali (University of Naples Federico II) -
  **Named Entity Recognition using context similarity data augmentation**
  _(4mins)_ \[[pdf](papers/paper20.pdf)\]
- #22 -
  Chiara Criscuolo (Politecnico di Milano)\*;
  Tommaso Dolci (Lero, University of Limerick);
  Mattia Salnitri (Politecnico di Milano) -
  **Mitigating Unfairness in Machine Learning: A Taxonomy and an Evaluation Pipeline**
  _(4mins)_ \[[pdf](papers/paper22.pdf)\]
- #28 -
  Marco Calautti (University of Milan)\*;
  Damiano Duranti (University of Trento);
  Paolo Giorgini (University of Trento) -
  **Machine Learning-Augmented Ontology-Based Data Access for Renewable Energy Data**
  _(4mins)_ \[[pdf](papers/paper28.pdf)\]
- #31 -
  Teresa Baldassarre (University of Bari “A. Moro”);
  Danilo Caivano (University of Bari “A. Moro”);
  Domenico Gigante (University of Bari “A. Moro”)\*;
  Azzurra Ragone (University of Bari)\* -
  **POLARIS: A framework to guide the development of Trustworthy AI systems**
  _(4mins)_ \[[pdf](papers/paper31.pdf)\]
- #35 -
  Manuel A Goyo (Universidad Técnica Federico Santa María)\*;
  Giacomo Frisoni (University of Bologna, Italy);
...
- #44 -
  ...
  Valerio Bellandi (Università degli Studi di Milano);
  Marco Luzzara (Università Degli Studi Di Milano);
  ...
  **Data Pipelines Assessment: The Role of Data Engine Deployment Models**
  _(4mins)_ \[[pdf](papers/paper44.pdf)\]
- #45 - 
  Théo Abgrall (Free University of Bozen-Bolzano)\* -
  **Schema Decomposition via Transformation Patterns**
  _(4mins)_ \[[pdf](papers/paper45.pdf)\]
- #46 -
...
- #57 -
  ...
  **Symbolic Regression for Transparent Clinical Decision Support: A Data-Centric Framework for Scoring System Development**
  _(4mins)_ \[[pdf](papers/paper57.pdf)\]
- #60 -
  Gianluca Nogara (SUPSI);
  Francesco Pierri (Politecnico di Milano)\*;
  Stefano Cresci (IIT-CNR);
  Luca Luceri (Information Sciences Institute USC);
  Petter Tornberg (University of Amsterdam);
  Silvia Giordano (Networking Lab, University of Applied Sciences of Southern Switzerland SUPSI, Switzerland.) -
  **Biases in Toxicity Detection Models**
  _(4mins)_ \[[pdf](papers/paper60.pdf)\]
- #71 -
  Anisa Rula (University of Brescia)\* -
  **Exploring Large Language Models for Procedure Extraction from Documents**
  _(4mins)_ \[[pdf](papers/paper71.pdf)\]
- #72 -
  Lorenzo Balzotti (Sapienza University of Rome)\*;
  Paolo Franciosa (Sapienza University of Rome) -
  **Max Flow Vulnerability of Undirected Planar Networks**
  _(4mins)_ \[[pdf](papers/paper72.pdf)\]
- #73 -
  Andrea Pasin (University of Padua)\*;
  Lorenza Da Re (University of Padua);
  Andrea Gerosa (University of Padua);
  Lidia Pezzuoli (University of Padua);
  Silvia Preciso (University of Padua);
  ...
  **PNRRorienta: A Web Application for Managing Schools, Courses, and Students Involved in the PNRR Orientation Initiative**
  _(4mins)_ \[[pdf](papers/paper73.pdf)\]
- #76 -
  Loredana Caruccio (University of Salerno);
  Gaetano Cimino (University of Salerno);
  Stefano Cirillo (University of Salerno)\*;
  Domenico Desiato (University of Salerno);
  ...
  **Improving Malicious Accounts Discrimination through a New Feature Engineering Approach Using Relaxed Functional Dependencies**
  _(4mins)_ \[[pdf](papers/paper76.pdf)\]
- #79 -
  Sara Colantonio (Institute of Information Science and Technologies of the National Research Council of Italy)\*;
  Andrea Berti (Institute of Information Science and Technologies of the National Research Council of Italy);
  Gianluca Carloni (Institute of Information Science and Technologies of the National Research Council of Italy);
  Claudia Caudai (CNR);
  Giulio Del Corso (ISTI-CNR);
  Danila Germanese (Institute of Information Science and Technologies of the National Research Council of Italy);
  Eva Pachetti (Institute of Information Science and Technologies of the National Research Council of Italy);
  Maria Antonietta Pascali (Institute of Information Science and Technologies of the National Research Council of Italy);
  Valia Kalokyri (Foundation of Research and Technology Hellas);
  Haridimos Kondylakis (FORTH-ICS);
  Charalampos Kalantzopoulos (Foundation for Research and Technology Hellas);
  Nikolaos Tachos (Foundation of Research and Technology Hellas);
  Dimitris Fotiadis (Foundation for Research and Technology Hellas);
  Valentina Giannini (University of Turin);
  Simone Mazzetti (Department of Radiology, Candiolo Cancer Institute);
  Daniele Regge (Department of Radiology, Candiolo Cancer Institute);
  Nickolas Papanikolaou (Champalimaud Foundation);
  Kostas Marias (FORTH);
  ...
  **Data and System Traceability for Transparent AI in Medical Imaging**
  _(4mins)_ \[[pdf](papers/paper79.pdf)\]
- #85 -
  Francesco Blefari (Università della Calabria)\*;
  Angelo Furfaro (Università della Calabria);
  Giovambattista Ianni (Università della Calabria);
  Alessandro Viscomi (Università della Calabria) -
  **TypoAlert: a browser extension against typosquatting**
  _(4mins)_ \[[pdf](papers/paper85.pdf)\]
- #86 -
  Cristian Martella (University of Salento)\*;
  Angelo Martella (University of Salento);
...
**Session chair:** _Vincenzo Moscato (Università di Napoli Federico II)_
...
- #5 -
  ...
  **Building Taxonomies with Triplet Queries**
  _(10mins)_ \[[pdf](papers/paper05.pdf)\]
- #15 -
  Matteo Lissandrini (University of Verona)\*;
  Kashif Rabbani (Aalborg University Denmark);
  Katja Hose (TU Wien) -
  **Mining Validating Shape for Large Knowledge Graphs via Dynamic Reservoir Sampling**
  _(10mins)_ \[[pdf](papers/paper15.pdf)\]
- #8 -
  Gianmaria Silvello (University of Padova)\*;
  Dennis Dosso (SIAV SpA) -
  **A Provenance-Based Caching System to Speed-up SPARQL Query Answering** _(15mins)_ \[[pdf](papers/paper08.pdf)\]
- #34 -
  Marco Calautti (University of Milan)\*;
  ...
  **Computing the Why-Provenance for Datalog Queries via SAT Solvers**
  _(10mins)_ \[[pdf](papers/paper34.pdf)\]
- #53 -
  Emanuele Cavalleri (Università degli Studi di Milano);
  Mauricio Soto Gomez (University of Milano);
  Ali Pashaeibarough (University Of Milano);
  Dario Malchiodi (Università degli Studi di Milano);
  Harry Caufield (Environmental Genomics and Systems Biology Division, Lawrence Berkeley National Laboratory, Berkeley, CA, USA);
  Justin Reese (Environmental Genomics and Systems Biology Division, Lawrence Berkeley National Laboratory, Berkeley, CA, USA);
  Peter Robinson (Berlin Institute of Health - Charite’, Universitatsmedizin, Berlin, 13353, Germany);
  Chris J Mungall (Lawrence Berkeley National Laboratory);
  Elena Casiraghi (University Of Milano);
  Giorgio Valentini (University Of Milano);
...
**Session chair:** _Donatella Firmani (Sapienza Università di Roma)_
...
- #64 -
  ...
  **Assessing Speech Model Performance: A Subgroup Perspective**
  _(10mins)_ \[[pdf](papers/paper64.pdf)\]
- #62 -
  Alfredo Cuzzocrea (Universitá della Calabria)\*;
  Geertruida H. de Bock (University of Groningen);
  Willemijn J. Maas (University of Groningen);
  Selim Soufargi (University of Calabria);
  Abderraouf Hafsaoui (iDEA Lab, University of Calabria) -
  **An Innovative Big Temporal Data Analytics Technique over Real- Life Healthcare Datasets: The F-TBDA Approach**
  _(15mins)_ \[[pdf](papers/paper62.pdf)\]
- #1 -
...
**Session chair:** _Elio Masciari (Università di Napoli Federico II)_
...
- #10 -
  ...
  **Bootstrapping Gene Expression-Cancer Knowledge Bases with Limited Human Annotations**
  _(10mins)_ \[[pdf](papers/paper10.pdf)\]
- #43 -
  Francesco Cauteruccio (Università degli Studi di Salerno);
  Michele Marchetti (Università Politecnica delle Marche);
  Davide Traini (Università di Modena e Reggio Emilia);
  Domenico Ursino (Università Politecnica delle Marche);
  Luca Virgili (Università Politecnica delle Marche)\* -
  **Speeding up Vision Transformers Through Reinforcement Learning**
  _(10mins)_ \[[pdf](papers/paper43.pdf)\]
- #81 -
  C. Aiswarya (Chennai Mathematical Institute, Chennai, India);
  ...
  **Verification of Unary Communicating Datalog Programs**
  _(10mins)_ \[[pdf](papers/paper81.pdf)\]
- #30 -
  Annunziata D’Aversa (University of Bari “Aldo Moro”)\*;
  ...
  **Nowcasting of the energy production of wind power plants through spatially-aware model trees**
  _(10mins)_ \[[pdf](papers/paper30.pdf)\]
- #26 -
  Francesco Scala (CNR-ICAR and Unical)\*;
  Sergio Flesca (Unical);
  Luigi Pontieri (CNR-ICAR) -
...
**Session chair:** _Riccardo Torlone (Università Roma Tre)_
...
- #65 -
  ...
  **Text-to-SQL with Large Language Models: Exploring the Promise and Pitfalls**
  _(10mins)_ \[[pdf](papers/paper65.pdf)\]
- #68 -
  Andrea Avignone (Politecnico di Torino)\*;
  ...
  **From Product Sheet to Text and Video: A NLG Pipeline to Transform Structured Data into Comprehensive Descriptions**
  _(10mins)_ \[[pdf](papers/paper68.pdf)\]
- #13 -
...
- #17 -
  ...
  **Enhancing Next Activity Prediction with Adversarial Training of Vision Transformers**
  _(10mins)_ \[[pdf](papers/paper17.pdf)\]
- #84 -
...
**Session chair:** _Francesco Buccafurri (Università Mediterranea di Reggio Calabria)_

- #41 -
  Gianluca Bonifazi (Università Politecnica delle Marche);
  Enrico Corradini (Polytechnic University of Marche)\*;
  Domenico Ursino (Università Politecnica delle Marche) -
  **Evaluating status and value assortativity in Threads**
  _(10mins)_ \[[pdf](papers/paper41.pdf)\]
- #49 -
  Pietro Hiram Guzzi (Univ. Magna Gracia of Catanzaro, IPC, ICIEV)\*;
  Pierangelo Veltri (Unical);
  Patrizia Vizza (University of Catanzaro);
  Sergio Greco (Unical);
  Giuseppe Tradigo (eCampus University) -
  **Design of a Telemedicine Infrastructure for Rural and Remote Areas**
  _(10mins)_ \[[pdf](papers/paper49.pdf)\]
- #70 -
...
**Session chair:** _Enrico Franconi (Libera Università di Bolzano)_

- #27 -
  Barbara Pernici (Politecnico di Milano)\*;
  Cinzia Cappiello (Politecnico di Milano);
  Edoardo Ramalli (Politecnico di Milano, MIT);
  ...
  Matteo Filosa (University of Roma “La SApienza”);
  Marco Angelini (University of Rome “La Sapienza”);
  Dario Benvenuti (Sapienza, University of Rome) -
  **The Future of Sustainable Data Preparation**
  _(10mins)_ \[[pdf](papers/paper27.pdf)\]
- #51 -
  ...
  **Comparing Incomplete Database Instances**
  _(10mins)_ \[[pdf](papers/paper51.pdf)\]
- #11 -
...
**Session chair:** _Stefano Montanelli (Università degli Studi di Milano)_
...
- #21 -
  ...
  Valerio La Gatta (University of Naples Federico II);
  Francesco Moscato (University of Salerno);
  Vincenzo Moscato (University of Naples “Federico II”);
  Carlo Sansone (Universita’ degli Studi di Napoli);
  Giancarlo Sperlì (University of Naples Federico II) -
  **A Comparative Assessment of eXplainable AI Tools in Predicting Hard Disk Drive Health**
  _(10mins)_ \[[pdf](papers/paper21.pdf)\]
- #39 -
  Elisabetta Rocchetti (Università degli Studi di Milano)\*;
  Alfio Ferrara (Università degli Studi di Milano) -
  **Causal Mediation Analysis for Interpreting Large Language Models**
  _(10mins)_ \[[pdf](papers/paper39.pdf)\]
- #48 -
  Luca Ferragina (University of Calabria);
...
**Session chair:** _Maurizio Atzori (Università di Cagliari)_
...
- #24 -
  ...
  **Overlap-Based Duplicate Table Detection**
  _(10mins)_ \[[pdf](papers/paper24.pdf)\]
- #50 -
  Devis Bianchini (University of Brescia);
  Valeria De Antonellis (University of Brescia);
  Massimiliano Garda (University of Brescia)\* -
  **Personalised Exploration Graphs on top of Data Lakes**
  _(10mins)_ \[[pdf](papers/paper50.pdf)\]
- #55 -
  Matteo Paganelli (Hasso Plattner Institute);
  Donato Tiano (Università degli Studi di Modena e Reggio Emilia);
  Francesco Del Buono (University of Modena e Reggio Emilia);
  Andrea Baraldi (Università di Modena e Reggio Emilia);
  Riccardo Benassi (Università di Modena e Reggio Emilia);
  Giacomo Guiduzzi (University of Modena and Reggio Emilia);
...
**Session chair:** _Paolo Missier (University of Birmingham)_
...
- #33 -
  ...
  **CAMEO: Fostering Joint Conversational Search and Recommendation**
  _(10mins)_ \[[pdf](papers/paper33.pdf)\]
- #52 -
  Jean-Flavien Bussotti (Eurecom);
  Enzo Veltri (Università della Basilicata)\*;
  Donatello Santoro (Università della Basilicata);
  Paolo Papotti (EURECOM) -
  **A Framework for the Generation of Training Examples from Tabular Data**
  _(10mins)_ \[[pdf](papers/paper52.pdf)\]
- #58 -
  Alessandro Sajeva (Università degli Studi Roma Tre)\*;
  Paolo Merialdo (Università degli Studi Roma Tre);
  Carlo Marchetti (Senato della Repubblica Italiana);
  Stefano Iannucci (Roma Tre University);
  Riccardo Torlone (Roma Tre University) -
  **Clustering Amendments with Semantic Embeddings**
  _(10mins)_ \[[pdf](papers/paper58.pdf)\]
